...
struct Grid
{
	...
	int* centers;  		// M elements, center of each block

	Grid() {support = NULL; celltypes = NULL; offsets = NULL; centers = NULL; }
	~Grid(){ delete[] support; delete[] celltypes; delete[] offsets; delete[] centers; }
	void print();
};
/* ************************************************************************** */
struct Matrix
