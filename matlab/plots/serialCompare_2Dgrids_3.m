...
OMP_iter_100=[	
45.0118	182.577	410.4	734.551	1141.3
];


MPI_iter_100 =[
32.16	129.1	295.2	521.6	819.7
];
...
height = [ 1 1  1 1 -8 ]*1250/35;
height2 = [ 1 1 1 1 1 ]*1250/35;
...
set(gca,'fontsize',15)
set(gca,'XLim',[0.5 5.5],'YLim',[0 1200])
...
print -dpdf -painters serialCompare_1600
%}
