...
OMP_iter_100=[	
0.0982351	0.395162	0.889607	1.58753	2.47093
]*1000;
...
MPI_iter_100 =[
0.03037	0.1252	0.2916	0.5457	0.895
]*1000;
...
height = [ 1 1 1 1 -8 ]*2500/35;
height2 = [ 1 1 1 1 1 ]*2500/35;
...
set(gca,'XLim',[0.5 5.5],'YLim',[0 2500])
...
print -dpdf -painters serialCompare_setup_400
%}
