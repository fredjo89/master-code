...
for (k = 0; k<IT; k++){
	...
	if (RANK==0){
		...
		//if (SIZE==1) cout<<T3<<"\t\t"<<T4<<endl<<endl;
		//cout<<T1<<"\t\t"<<T2<<endl<<endl;
		////cout<<T1/IT<<endl<<T2/opt.maxIter/IT<<endl<<endl;

		if (SIZE==1)cout<<T4/opt.maxIter/IT<<endl;
		cout<<T2/opt.maxIter/IT<<endl;

		//if (SIZE==1)cout<<T3/IT<<endl;
		//cout<<T1/IT<<endl;

		if (SIZE==4) cout<<endl<<endl;
	}
